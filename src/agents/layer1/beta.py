"""Beta Agent - AI Software & Cloud Specialist."""
...
class BetaAgent(Layer1Agent):
    """Beta agent specializing in AI software and cloud infrastructure."""

    # Default coverage universe for software/cloud
    DEFAULT_TICKERS = [
        "MSFT", "GOOGL", "AMZN", "META",  # Hyperscalers
        "CRM", "NOW", "ADBE", "ORCL",     # Enterprise software
        "SNOW", "PLTR", "MDB", "DDOG",    # Data/MLOps
        "NET", "ZS", "CRWD", "PANW",      # Cloud security
        "TEAM", "ESTC", "CFLT",           # Developer tools
    ]
    ...
    async def analyze(
        ...
        """Analyze software/cloud companies.
        ...
        Returns:
            AgentOutput with top 5 software/cloud picks
        """
        ...
        return AgentOutput(
            ...
            layer=self.layer,
            picks=picks,
            reasoning=f"Analysis based on {len(data.get('companies', {}))} companies in software/cloud sector.",
            metadata={
    ...
    def _is_relevant_sector(self, company_data: Any) -> bool:
        ...
        if isinstance(company_data, str):
            ...
            return any(term in company_data_lower for term in relevant_terms)
        ...
        return any(term in sector or term in industry for term in relevant_terms)
